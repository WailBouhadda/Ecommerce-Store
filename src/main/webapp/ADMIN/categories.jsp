                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                   ...
                   <form action="actionCategorie" method="post">
                      ...
                      <td><input style="border: none;background: transparent;" class="<%=c.getId() %>" type="text" name="title" value="<%=c.getName() %>" disabled></td>
                      <td><input style="border: none;background: transparent;" class="<%=c.getId() %>" type="text" name="id" value="<%=cdao.countPhonesByCategorie(c.getId()) %>" readonly></td>
...
function update(id){
	...
	for(var i = 0 ; i < row.length ; i++){
		if(row[i].classList[0] == id){	
			Srow = row[i];			
			Srow.style = "background-color: black;"
		}
	}
